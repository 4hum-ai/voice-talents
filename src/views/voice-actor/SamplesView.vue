      ...
      <div class="mb-8">
        <div class="flex flex-col sm:flex-row gap-4">
          <div class="flex-1">
            <SearchInput
              v-model="searchQuery"
              placeholder="Search samples by title, genre, or tags..."
        ...
        >
          ...
          <div class="p-4">
            ...
            <div class="flex items-center justify-between text-xs text-muted-foreground">
              ...
              <div class="flex items-center">
                <Icon
                  :name="sample.isPublic ? 'eye' : 'eye-off'"
                  class="h-3 w-3"
                />
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              <div class="flex space-x-2">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  @click.stop="$router.push(`/samples/${sample.id}/edit`)"
                >
                  <EditIcon class="h-4 w-4" />
                </Button>
              </div>
              <ActionsMenu
                :items="getSampleActions(sample)"
                size="sm"
