          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                  ...
                  <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                      <Chip v-for="language in profile.languages" :key="language" variant="primary">
                        {{ language }}
                      </Chip>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                      <Chip v-for="accent in profile.accents" :key="accent" variant="secondary">
                        {{ accent }}
                      </Chip>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                      <Chip v-for="voiceType in profile.voiceTypes" :key="voiceType" variant="outline">
                  ...
                  <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                      <Chip v-for="skill in profile.skills" :key="skill" variant="success">
                        {{ skill }}
                      </Chip>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Chip :variant="getExperienceVariant(profile.experience)" size="lg">
                  ...
                  <div>
                    ...
                    <StatusBadge :status="profile.availability" :variant="getAvailabilityVariant(profile.availability)" />
                  </div>
                </div>
              </Card>
              ...
              <Card>
                ...
                <div class="space-y-4">
                  ...
                  <div v-if="profile.demoReelUrl">
                    ...
                    <Button variant="outline" @click="openDemoReel" class="w-full justify-start">
                  ...
                  <div v-if="profile.website">
                    ...
                    <Button variant="outline" @click="openWebsite" class="w-full justify-start">
                  ...
                  <div v-if="hasSocialLinks">
                    ...
                    <div class="flex space-x-2">
                      <Button v-if="profile.socialLinks.twitter" variant="outline" size="sm"
                        @click="openSocialLink('twitter', profile.socialLinks.twitter!)">
                        <TwitterIcon class="h-4 w-4" />
                      </Button>
                      <Button v-if="profile.socialLinks.linkedin" variant="outline" size="sm"
                        @click="openSocialLink('linkedin', profile.socialLinks.linkedin!)">
                        <LinkedinIcon class="h-4 w-4" />
                      </Button>
                      <Button v-if="profile.socialLinks.instagram" variant="outline" size="sm"
                        @click="openSocialLink('instagram', profile.socialLinks.instagram!)">
                        <InstagramIcon class="h-4 w-4" />
                      </Button>
                      <Button v-if="profile.socialLinks.youtube" variant="outline" size="sm"
            ...
            <div class="space-y-8">
              ...
              <Card>
                ...
                <div class="space-y-3">
                  <Button variant="outline" class="w-full justify-start" @click="$router.push('/samples/upload')">
                    <UploadIcon class="h-4 w-4 mr-3" />
                    Upload Voice Sample
                  </Button>
                  <Button variant="outline" class="w-full justify-start" @click="$router.push('/casting')">
                  ...
                  <Button variant="outline" class="w-full justify-start" @click="copyProfileLink">
                  ...
                  <div v-for="activity in recentActivity" :key="activity.id" class="flex items-start space-x-3">
                    <div class="flex-shrink-0">
                      <div class="w-6 h-6 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center">
                        <Icon :name="getActivityIcon(activity.type)" class="h-3 w-3 text-blue-600 dark:text-blue-400" />
                      </div>
                    </div>
                    <div class="flex-1 min-w-0">
...
const recentActivity = ref<ActivityItem[]>([
  {
    id: '1',
    type: 'sample_upload',
    title: 'Uploaded new voice sample: "Commercial Demo"',
    timestamp: '2024-01-15T10:30:00Z'
  },
  {
    id: '2',
    type: 'project_completed',
    title: 'Completed project: "Audiobook Narration"',
    timestamp: '2024-01-14T16:45:00Z'
  },
  {
    id: '3',
    type: 'rating_received',
    title: 'Received 5-star rating from client',
...
const getActivityIcon = (type: string) => {
  const icons = {
    sample_upload: 'mdi:upload',
    project_completed: 'mdi:check-circle',
    rating_received: 'mdi:star',
    message_received: 'mdi:message',
    casting_applied: 'mdi:send'
  }
...
const shareProfile = () => {
  if (navigator.share) {
    navigator.share({
      title: `${profile.value.displayName} - Voice Actor Profile`,
