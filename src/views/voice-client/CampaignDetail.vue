        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
              ...
              <div>
                <h1 class="text-foreground text-2xl font-bold">Campaign Details</h1>
                <p class="text-muted-foreground text-sm">View and manage campaign details</p>
              </div>
            </div>
      ...
      <div class="px-4 py-8 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-7xl">
          <div class="py-12 text-center">
            ...
            <h3 class="text-foreground mb-2 text-lg font-medium">Campaign Details</h3>
            <p class="text-muted-foreground mb-6">
              This view will show detailed information about a specific campaign
            </p>
          </div>
        </div>
      </div>
