...
const firebaseConfig = {
  apiKey: (import.meta as unknown as Meta).env.VITE_FIREBASE_API_KEY,
  authDomain: (import.meta as unknown as Meta).env?.VITE_FIREBASE_AUTH_DOMAIN,
  projectId: (import.meta as unknown as Meta).env?.VITE_FIREBASE_PROJECT_ID,
  storageBucket: (import.meta as unknown as Meta).env?.VITE_FIREBASE_STORAGE_BUCKET,
  messagingSenderId: (import.meta as unknown as Meta).env?.VITE_FIREBASE_MESSAGING_SENDER_ID,
  appId: (import.meta as unknown as Meta).env?.VITE_FIREBASE_APP_ID,
}
