...
export function useJob() {
  ...
  const createJob = (
    ...
    const job: Job = {
      ...
      voiceType: jobData.voiceType || 'talent_only',
      projectType: jobData.projectType || 'commercial',
      status,
      priority: jobData.priority || 'medium',
      budget: jobData.budget || { max: 0, currency: 'USD' },
      ...
      talentOptions: jobData.talentOptions || {
        isPublic: true,
        pickOwn: false,
        selectedTalents: [],
      },
      aiSettings: jobData.aiSettings,
      premiumFeatures: jobData.premiumFeatures || {
      ...
      requirePortfolio: jobData.requirePortfolio ?? true,
