...
export const mockVoiceActors: VoiceActor[] = [
  ...
  },
  {
    ...
    hourlyRate: 100,
    currency: 'USD',
    demoReelUrl: 'https://example.com/demo-reel-alex',
    website: 'https://alexthompsonvoice.com',
    socialLinks: {
      linkedin: 'alex-thompson-voice',
      twitter: '@alexthompsonvo',
    },
    isVerified: true,
    isPublic: true,
    totalProjects: 15,
    ...
    averageRating: 4.6,
    totalEarnings: 25000,
    joinedDate: '2022-05-15T10:00:00Z',
  ...
  },
  {
    ...
    bio: 'Fresh voice talent with a modern edge, perfect for connecting with younger audiences. Specializes in digital marketing and startup commercial work.',
    avatarUrl:
    ...
    hourlyRate: 80,
    currency: 'USD',
    demoReelUrl: 'https://example.com/demo-reel-jessica',
    website: 'https://jessicaparkvoice.com',
    socialLinks: {
      instagram: '@jessicaparkvo',
      linkedin: 'jessica-park-voice',
    },
    isVerified: true,
    isPublic: true,
    totalProjects: 8,
    ...
    averageRating: 4.4,
    totalEarnings: 12000,
    joinedDate: '2023-03-10T11:00:00Z',
