            ...
            <div :key="currentStep" class="space-y-8">
              ...
              <div v-if="currentStep === 3" class="space-y-8">
                <div class="text-center">
                  ...
                  <p class="text-muted-foreground">
                    Select all the types of voice work you specialize in. This helps clients find
                    the perfect voice for their projects.
                  </p>
                </div>
              ...
              <div v-if="currentStep === 4" class="space-y-8">
                <div class="text-center">
                  ...
                  <p class="text-muted-foreground">
                    Select all the languages you're comfortable working in. This opens up more
              ...
              <div v-if="currentStep === 5" class="space-y-8">
                <div class="text-center">
                  ...
                  <h3 class="text-foreground mb-2 text-2xl font-semibold">
                    Let's Hear Your Amazing Voice!
                  </h3>
                  <p class="text-muted-foreground">
                    Upload samples for each type of voice work you selected. This showcases your
              ...
              <div v-if="currentStep === 6" class="space-y-8">
                <div class="text-center">
                  ...
                  <p class="text-muted-foreground">
                    Share your rates for different types of voice work. This helps clients
                    understand your pricing and find the perfect match for their budget.
                  </p>
                </div>
...
const processFile = (file: File, voiceType: string) => {
  ...
  success(
    `Great! Your ${voiceTypeOptions.find((vt) => vt.value === voiceType)?.label} sample is ready!`,
  )
}
